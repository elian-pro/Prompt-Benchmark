...
| **Active sprint — ticket-by-ticket plan** | `docs/SPRINT-1.md` |
...
**Sprint 1 — Settings + Library.** See `docs/SPRINT-1.md`.
When Sprint 1 finishes, update this line to point to `docs/SPRINT-2.md`
and archive SPRINT-1.md.
