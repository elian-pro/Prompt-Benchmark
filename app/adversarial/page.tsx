    ...
    <div>
      ...
      {isEmpty && (
        <EmptyState
          ...
          title="No hay pruebas todavía"
          description="Lanza una prueba adversaria: un lead simulado conversa con el prompt de un cliente y un juez reporta dónde falla."
          action={
            <Button
              variant="primary"
              icon={<IconPlus size={14} />}
