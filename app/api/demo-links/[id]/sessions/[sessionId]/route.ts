...
/**
 * One client conversation, read only, for the admin's right hand column. Every
 * round of it: what the client restarted past is still what they tested, and
 * their reports about it have to quote something.
 *
